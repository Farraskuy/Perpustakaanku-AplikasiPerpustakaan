                            ...
                            <div class="col-lg-6 p-2 p-sm-4 p-md-3">
                                <div class="card-body text-black">
                                    ...
                                    <form action="<?= url_to('register') ?>" method="post">
                                        ...
                                        <div class="pt-1 mb-3">
                                            <button class="btn btn-lg btn-purple btn-block fs-6" style="color: white;" type="submit"><?= lang('Auth.register') ?></button>
                                        </div>


                                        <p class="text-purple">Sudah daftar keanggotaan <a href="<?= url_to('login') ?>"><?= lang('Auth.signIn') ?></a></p>
