<nav class="navbar fixed-top navbar-expand bg-white shadow">
    <div
        class="<?= in_groups(['admin', 'petugas']) ? 'container-fluid px-5 d-flex justify-content-between' : 'container' ?>">
        ...
        <?php if (!in_groups(['admin', 'petugas'])): ?>
            <ul class="navbar-nav ms-auto me-2 my-2 my-lg-0 navbar-nav-scroll">
                <li class="nav-item me-1">
                    <a href="/pinjam" class="nav-link" aria-current="page" data-bs-toggle="tooltip"
                        data-bs-placement="bottom" data-bs-title="Pinjamanku">
                ...
                <div style="height: 45px; width: 170px;" class="row g-0">
                    ...
                    <div class="h-100 col-3 text-center">
                        <img style="object-fit: cover;" class="rounded-circle" height="40" width="40"
                            src="/upload/petugas/<?= isset($foto) ? $foto : 'default.png' ?>" alt="">
                    </div>
                </div>
            </a>
            <ul style="top: 50px;" class="dropdown-menu dropdown-menu-end" data-bs-popper="static">
                <li><a class="dropdown-item small" href="/profile"><i class="fa-regular fa-user"></i> Profile</a></li>
                <li>
                    <hr class="dropdown-divider m-1">
                </li>
                <li>
                    <?php if (logged_in()): ?>
                        <a class="dropdown-item small" href="/logout"><i class="fa-regular fa-right-from-bracket"></i>
                            Logout</a>
                    <?php else: ?>
                        <a class="dropdown-item small" href="/login"><i class="fa-regular fa-arrow-right-from-bracket"></i>
                            Login</a>
                    <?php endif ?>
                </li>
            </ul>
