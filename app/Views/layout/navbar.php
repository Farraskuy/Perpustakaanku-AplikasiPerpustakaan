    ...
    <div class="<?= in_groups('admin') ? 'container-fluid px-5 d-flex justify-content-between' : 'container' ?>">
        ...
        <ul class="navbar-nav ms-auto me-2 my-2 my-lg-0 navbar-nav-scroll">
            <li class="nav-item me-3">
                <a class="nav-link" aria-current="page" href="#" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Pinjamanku">
    ...
    <div class="<?= in_groups('admin') ? 'container-fluid px-5 d-flex justify-content-between' : 'container' ?>">
        ...
        <?php if (!in_groups('admin')) : ?>
            <ul class="navbar-nav ms-auto me-2 my-2 my-lg-0 navbar-nav-scroll">
                ...
                <li class="nav-item">
                    <a href="" class="nav-link text-primary h-100 d-flex align-items-center rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Bookmark">
