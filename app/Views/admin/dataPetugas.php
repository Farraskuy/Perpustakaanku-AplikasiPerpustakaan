...
<section class="p-5">
    <div class="row mb-3">
        ...
        <div class="col-md-6 d-flex justify-content-end">
            <button class="btn btn-success" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tambahPetugasModal">Tambah Data Petugas</button>
        </div>
    </div>
            ...
            <tbody>
                ...
                <?php foreach ($data as $item) : ?>
                    <tr>
                        ...
                        <td><?= $item['agama'] ?></td>
                        <td><?= $item['jabatan'] ?></td>
                        <td><a class="btn btn-primary" href="/admin/petugas/<?= $item['id'] ?>">Detail</a></td>
                    </tr>
                <?php endforeach ?>
...
<div class="modal fade" id="tambahPetugasModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
