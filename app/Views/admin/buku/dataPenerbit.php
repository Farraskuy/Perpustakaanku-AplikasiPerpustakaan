        ...
        <tbody>
            ...
            <?php foreach ($data as $item) : ?>
                <tr>
                    ...
                    <td class="fit">
                        <button data-id="<?= $item['id_penerbit'] ?>" data-nilai="<?= $item['nama'] ?>" type="button" class="btn btn-warning text-white" data-bs-toggle="modal" data-bs-target=".editMasterBuku"><i class="fa-regular fa-pen-to-square"></i></button>
                        <button data-id="<?= $item['id_penerbit'] ?>" type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapus"><i class="fa-regular fa-trash-xmark"></i></button>
                    </td>
                </tr>
            <?php endforeach ?>
...
<div class="modal fade" id="tambah" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <form class="modal-content" method="post" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="modal-body">
                <div class="row">
                    <label for="penerbit" class="col-sm-3 form-label m-0">Nama <?= $subtitle ?></label>
                    <div class="col-sm-9">
        ...
        <form class="modal-content" method="post" action="/<?= uri_string() ?>/">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control <?= isset($validation['penerbit_edit']) ? 'is-invalid' : '' ?>" value="<?= old('penerbit_edit') ?>" name="penerbit_edit" id="inputEditMasterBuku">
                        <div class="invalid-feedback"><?= isset($validation['penerbit_edit']) ? $validation['penerbit_edit'] : '' ?></div>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
