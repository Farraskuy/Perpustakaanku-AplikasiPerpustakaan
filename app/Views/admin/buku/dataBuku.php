    ...
    <div class="row align-items-center">
        ...
        <div class="col-md-6 d-flex justify-content-end align-items-center">
            <button class="btn btn-success fw-semibold" type="button" data-bs-toggle="modal"
                data-bs-target="#tambah">Tambah Data <?= $subtitle ?></button>
        </div>
    </div>
</div>
        ...
        <tbody>
            ...
            <?php foreach ($data as $item): ?>
                <tr>
                    ...
                    <td class="fit">
                        <div
                            class="d-flex flex-column align-items-center gap-2 fs-6 border rounded-3 position-relative p-2  mt-2 pt-3">
                            <span class="badge rounded-pill text-bg-secondary position-absolute w-100"
                                style="top: -10px;">Total : <?= $item['jumlah_buku'] ?></span>
                            <span class="flex-grow-1 badge rounded-pill w-100 text-bg-primary">Tersedia :
                                <?= $item['jumlah_buku'] - $item['jumlah_terpinjam'] - $item['jumlah_rusak'] - $item['jumlah_hilang'] ?></span>
                            <span class="flex-grow-1 badge rounded-pill w-100 text-bg-success">Terpinjam :
                                <?= $item['jumlah_terpinjam'] ?></span>
                            <span class="flex-grow-1 badge rounded-pill w-100 text-bg-warning text-white">Rusak :
                                <?= $item['jumlah_rusak'] ?></span>
                            <span class="flex-grow-1 badge rounded-pill w-100 text-bg-danger">Hilang :
                                <?= $item['jumlah_hilang'] ?></span>

                        </div>
                    </td>
                    <td class="fit aksi">
                        <a class="btn btn-primary" href="/admin/buku/<?= $item['slug'] ?>"><i
                                class="fa-regular fa-eye"></i></a>
                        <a class="btn btn-warning text-white" href="/admin/buku/<?= $item['slug'] ?>/edit"><i
            ...
            <div class="modal-body">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="invalid-feedback">
                            <?= isset($validation['kategori']) ? $validation['kategori'] : '' ?></div>
                    </div>
                </div>
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-9">
                        <select class="form-select form-select-sm <?= isset($validation['rak']) ? 'is-invalid' : '' ?>"
                            ...
                            <?php foreach ($dataRak as $item): ?>
                                <option value="<?= $item['id_rak'] ?>" <?= old('rak') == $item['id_rak'] ? 'selected' : '' ?>>
                                    <?= $item['kode_rak'] . ' - ' . $item['nama'] . ' - ' . $item['lokasi'] ?></option>
                            <?php endforeach ?>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="invalid-feedback">
                            <?= isset($validation['penerbit']) ? $validation['penerbit'] : '' ?></div>
                    </div>
                </div>
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-9">
                        <input
                            ...
                            id="tanggalTerbit" value="<?= old('tanggal_terbit') ?>" name="tanggal_terbit" type="date" />
                        <div class="invalid-feedback">
                            <?= isset($validation['tanggal_terbit']) ? $validation['tanggal_terbit'] : '' ?></div>
                    </div>
                </div>
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-9">
                        <input
                            ...
                            id="jumlah_buku" value="<?= old('jumlah_buku') ?>" name="jumlah_buku" type="number" />
                        <div class="invalid-feedback">
                            <?= isset($validation['jumlah_buku']) ? $validation['jumlah_buku'] : '' ?></div>
                    </div>
                </div>
                <div class="mb-3 row">
                        ...
                        <div class="border rounded-3 text-center">
                            <div style="height: 150px;" class="w-100 p-3">
                                <img class="w-100 h-100 sampulPreview" style="object-fit: contain;"
                                    src="/upload/buku/default.png" alt="default sampul">
                            </div>
                            <input
                            ...
                            <div class="invalid-feedback">
                                <?= isset($validation['sampul']) ? $validation['sampul'] : '' ?></div>
                        </div>
                    </div>
                </div>
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-9">
                        <textarea
                            ...
                            name="sinopsis" id="sinopsis" rows="3"><?= old('sinopsis') ?></textarea>
                        <div class="invalid-feedback">
                            <?= isset($validation['sinopsis']) ? $validation['sinopsis'] : '' ?></div>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
