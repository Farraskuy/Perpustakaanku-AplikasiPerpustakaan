...
<section class="p-5">
    <div class="row mb-3 align-items-center">
        ...
        <div class="col-md-6 d-flex justify-content-end">
            <div class="d-flex bg-white rounded-3 p-2 px-3 align-items-center gap-3">
                <span class="fs-5 fw-semibold text-gray border-end pe-3">Aksi</span>
                <div class="btn-group" role="group" aria-label="Basic example">
                    <button style="min-width: 80px;" class="btn btn-warning text-white fw-semibold" type="button" data-bs-toggle="modal" data-bs-target="#editPetugas"><i class="fa-regular fa-pen-to-square"></i> Edit</button>
                    <button style="min-width: 80px;" class="btn btn-danger text-white fw-semibold" type="button" data-bs-toggle="modal" data-bs-target="#hapusPetugas"><i class="fa-regular fa-trash-xmark"></i> Hapus</button>
                </div>
            </div>
        </div>
    </div>
...
<!-- modal -->
<div class="modal fade" id="hapusPetugas" tabindex="-1" aria-hidden="true">
...
<div class="modal fade" id="editPetugas" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
