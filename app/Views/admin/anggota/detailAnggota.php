    ...
    <div class="row align-items-center">
        ...
        <div class="col-md-6 d-flex justify-content-end align-items-center gap-3">
            ...
            <div class="btn-group" role="group" aria-label="Basic example">
                ...
                <button style="min-width: 80px;" class="btn btn-danger text-white fw-semibold" type="button" data-bs-toggle="modal" data-bs-target="#hapusdalam"><i class="fa-regular fa-trash-xmark"></i> Hapus</button>
            </div>
...
<!-- modal -->
<!-- hapus -->
<div class="modal fade" id="hapusdalam" tabindex="-1" aria-hidden="true">
